...
public class main {
    ...
    public static void main(String[] args) {
        ...
        Album album = new Album("AlbumNew1", "AC/DC");
        album.addSong("TNT", 4.56);
        album.addSong("Highway to hell", 2.3);
        album.addSong("ThunderStruck", 3.2);
        albums.add(album);

        album = new Album("AlbumNew2", "Eminem");
        album.addSong("Rap god", 3.56);
            ...
            switch (action) {
                ...
                case 1:
                    ...
                    if (listIterator.hasNext()) {
                        ...
                        System.out.println("No song available, reachesd to the end of the list");
                        forward = false;
                    }
                    break;
                case 2:
